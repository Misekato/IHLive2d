var __pow = Math.pow, __async = (t, e, i) => new Promise(((s, r) => {
        var a = t => {
            try {
                n(i.next(t))
            } catch (e) {
...
(this, (function (t, e, i, s, r) {
        ...
        class _ extends e.EventEmitter {
            ...
            loadExpression(t) {
                return __async(this, null, (function  * () {
                        if (!this.definitions[t])
                            return void l.warn(this.tag, `Undefined expression at [${t}]`);
                ...
                return __async(this, null, (function  * () {
                        if (this.definitions.length) {
                            ...
                            for (let e = 0; e < this.definitions.length; e++)
                                null !== this.expressions[e] && this.expressions[e] !== this.currentExpression && e !== this.reserveExpressionIndex && t.push(e);
                            if (t.length) {
            ...
            setExpression(t) {
                return __async(this, null, (function  * () {
                        if ("number" != typeof t && (t = this.getExpressionIndex(t)), !(t > -1 && t < this.definitions.length))
                            return !1;
                        if (t === this.expressions.indexOf(this.currentExpression))
                            return !1;
        ...
        class x {
            ...
            getDefinedFiles() {
                const t = [];
                return this.replaceFiles((e => (t.push(e), e))),
                t
            }
            validateFiles(t) {
                const e = (e, i) => {
                    ...
                    if (!t.includes(s)) {
                        if (i)
                            throw new Error(`File "${e}" is defined in settings, but doesn't exist in given files`);
                        return !1
                    }
                    return !0
                };
        ...
        class M {
            ...
            reserve(t, e, i) {
                if (i <= 0)
                    return l.log(this.tag, "Cannot start a motion with MotionPriority.NONE."), !1;
                if (t === this.currentGroup && e === this.currentIndex)
                    return l.log(this.tag, "Motion is already playing.", this.dump(t, e)), !1;
                ...
                if (1 === i) {
                    ...
                    if (i < 3) {
                        if (i <= this.currentPriority)
                            return l.log(this.tag, "Cannot start motion because another motion is playing as an equivalent or higher priority.", this.dump(t, e)), !1;
                        if (i <= this.reservePriority)
                            return l.log(this.tag, "Cannot start motion because another motion has reserved as an equivalent or higher priority.", this.dump(t, e)), !1
                    }
            ...
            setReserved(t, e, i) {
                ...
                this.reservedGroup = t,
                this.reservedIndex = e
            }
            setReservedIdle(t, e) {
                this.reservedIdleGroup = t,
                this.reservedIdleIndex = e
            }
            isActive(t, e) {
        ...
        class v {
            ...
            static add(t, e, i) {
                ...
                s.addEventListener("error", (e => {
                        this.dispose(s),
                        l.warn("SoundManager", `Error occurred on "${t}"`, e.error),
                        null == i || i(e.error)
                    })),
                this.audios.push(s),
                s
        ...
        class C extends e.EventEmitter {
            ...
            loadMotion(t, e) {
                return __async(this, null, (function  * () {
                        ...
                        if (!(null == (i = this.definitions[t]) ? void 0 : i[e]))
                            return void l.warn(this.tag, `Undefined motion at "${t}"[${e}]`);
            ...
            startMotion(e, i) {
                return __async(this, arguments, (function  * (e, i, s = y.NORMAL) {
                        ...
                        if (this.currentAudio && v.dispose(this.currentAudio), t.config.sound) {
                            ...
                            if (t)
                                try {
                                    o = v.add(this.settings.resolveURL(t), (() => this.currentAudio = void 0), (() => this.currentAudio = void 0)),
                                    this.currentAudio = o
                                } catch (h) {
                ...
                return __async(this, null, (function  * () {
                        ...
                        if (null == i ? void 0 : i.length) {
                            ...
                            for (let e = 0; e < i.length; e++)
                                null === this.motionGroups[t][e] || this.state.isActive(t, e) || s.push(e);
                            if (s.length) {
            ...
            stopAllMotions() {
                ...
                this.state.reset(),
                this.currentAudio && (v.dispose(this.currentAudio), this.currentAudio = void 0)
            }
            update(t, e) {
                var i;
                return this.isFinished() && (this.playing && (this.playing = !1, this.emit("motionFinish")), this.state.shouldOverrideExpression() && (null == (i = this.expressionManager) || i.restoreExpression()), this.state.complete(), this.state.shouldRequestIdleMotion() && this.startRandomMotion(this.groups.idle, y.IDLE)),
        ...
        const w = class {
            static createXHR(t, e, i, s, r) {
                ...
                a.onloadend = () => {
                    var e;
                    w.allXhrSet.delete(a),
                    t && (null == (e = w.xhrMap.get(t)) || e.delete(a))
                },
                a
            }
            static cancelXHRs() {
                ...
                null == (t = w.xhrMap.get(this)) || t.forEach((t => {
                        t.abort(),
                        w.allXhrSet.delete(t)
                    })),
                w.xhrMap.delete(this)
            }
            static release() {
                w.allXhrSet.forEach((t => t.abort())),
                w.allXhrSet.clear(),
                w.xhrMap = new WeakMap
            }
        };
        let T = w;
        function L(t, e) {
        ...
        D = (t, e) => __async(this, null, (function  * () {
                if ("string" == typeof t.source) {
                    ...
                    e.url = t.source,
                    t.source = e,
                    t.live2dModel.emit("settingsJSONLoaded", e)
                }
                return e()
            })),
        A = (t, e) => __async(this, null, (function  * () {
                if (t.source instanceof x)
                ...
                if ("object" == typeof t.source) {
                    ...
                    if (i) {
                        ...
                        return t.settings = s,
                        t.live2dModel.emit("settingsLoaded", s),
                        e()
                    }
                }
                    ...
                    if (s) {
                        ...
                        e.pose && r.push(E.load({
                                ...
                                target: i
                                    ...
                                    l.warn(F, "Failed to load pose.", e)
                                }))),
                        e.physics && r.push(E.load({
                                ...
                                target: i
                                    ...
                                    l.warn(F, "Failed to load physics.", e)
                                }))),
        ...
        k = (t, e) => __async(this, null, (function  * () {
                ...
                if (i instanceof x) {
                    ...
                    return t.internalModel = s.createInternalModel(a, i, t.options),
                    e()
                }
                throw new TypeError("Missing settings.")
            })),
        U = class {
            static registerRuntime(t) {
                U.runtimes.push(t),
                U.runtimes.sort(((t, e) => e.version - t.version))
            }
                ...
                try {
                    ...
                    return null != n[i] || (n[i] = E.load({
                            ...
                            target: t
                                    ...
                                    return t.emit("motionLoaded", e, i, n),
                                    n
                                })).catch((e => {
                ...
                try {
                    ...
                    return null != r[e] || (r[e] = E.load({
                            ...
                            target: t
                                    ...
                                    return t.emit("expressionLoaded", e, a),
                                    a
                                })).catch((e => {
        ...
        class H extends r.Container {
            ...
            static fromSync(t, e) {
                const i = new this(e);
                return N.setupLive2DModel(i, t, e).then(null == e ? void 0 : e.onLoad).catch(null == e ? void 0 : e.onError),
                i
            }
            ...
            set autoUpdate(t) {
                ...
                t ? this._destroyed || (Y ? (Y.shared.add(this.onTickerUpdate, this), this._autoUpdate = !0) : l.warn(this.tag, "No Ticker registered, please call Live2DModel.registerTicker(Ticker).")) : (null == Y || Y.shared.remove(this.onTickerUpdate, this), this._autoUpdate = !1)
            }
            init(t) {
                ...
                e.autoInteract && (this.interactive = !0),
                this.autoInteract = e.autoInteract,
            ...
            hitTest(t, e) {
                return z.x = t,
                z.y = e,
                this.toModelPosition(z, z),
                this.internalModel.hitTest(z.x, z.y)
            }
            toModelPosition(t, e = t.clone(), i) {
                return i || (this._recursivePostUpdateTransform(), this.parent ? this.displayObjectUpdateTransform() : (this.parent = this._tempDisplayObjectParent, this.displayObjectUpdateTransform(), this.parent = null)),
            ...
            _render(t) {
                this.registerInteraction(t.plugins.interaction),
                t.batch.reset(),
                t.geometry.reset(),
                t.shader.reset(),
                t.state.reset();
        ...
        const q = class {
            ...
            static createSettings(t) {
                return __async(this, null, (function  * () {
                        ...
                        return a._objectURL = URL.createObjectURL(e),
                        a
                    }))
            }
            static readText(t) {
        ...
        let $ = q;
        $.filesMap = {},
        $.factory = (t, e) => __async(this, null, (function  * () {
                    ...
                    t.live2dModel.once("modelLoaded", (t => {
                            t.once("destroy", (function () {
                                    ...
                                    if (URL.revokeObjectURL(t), q.filesMap[t])
                                        for (const e of Object.values(q.filesMap[t]))
        ...
        if (J.ZIP_PROTOCOL = "zip://", J.uid = 0, J.factory = (t, e) => __async(this, null, (function  * () {
                    ...
                    if ("string" == typeof i && (i.endsWith(".zip") || i.startsWith(Z.ZIP_PROTOCOL)) ? (s = i.startsWith(Z.ZIP_PROTOCOL) ? i.slice(Z.ZIP_PROTOCOL.length) : i, r = yield E.load({
                        ...
                        if (!r.size)
                            ...
                            a || (a = yield Z.createSettings(e)),
                            a._objectURL = Z.ZIP_PROTOCOL + Z.uid + "/" + a.url;
                            const i = yield Z.unzip(e, a);
                            i.settings = a,
                            t.source = i,
                            s.startsWith("blob:") && t.live2dModel.once("modelLoaded", (t => {
                                    t.once("destroy", (function () {
        ...
        Live2DMotion.prototype.updateParam = function (t, e) {
            Q.call(this, t, e),
            e.isFinished() && this.onFinishHandler && (this.onFinishHandler(this), delete this.onFinishHandler)
        };
        class K extends AMotion {
            constructor(e) {
                ...
                Array.isArray(e.params) && e.params.forEach((t => {
                        const e = t.calc || "add";
                        if ("add" === e) {
                            const e = t.def || 0;
                            t.val -= e
        ...
        class et extends C {
            ...
            init(t) {
                super.init(t),
                this.settings.expressions && (this.expressionManager = new tt(this.settings, t))
            }
            isFinished() {
                return this.queueManager.isFinished()
            }
            createMotion(e, i, s) {
                ...
                return r.setFadeIn(s.fade_in > 0 ? s.fade_in : a),
                r.setFadeOut(s.fade_out > 0 ? s.fade_out : a),
                r
            }
            getMotionFile(t) {
                return t.file
        ...
        class it {
            ...
            update(t) {
                ...
                case 0:
                    ...
                    this.nextBlinkTimeLeft < 0 && (this.eyeState = 1, this.nextBlinkTimeLeft = this.blinkInterval + this.closingDuration + this.closedDuration + this.openingDuration + d(0, 2e3));
                    break;
                case 1:
        ...
        class rt extends b {
            ...
            init() {
                super.init(),
                this.settings.initParams && this.settings.initParams.forEach((({
                            id: t,
                            value: e
            ...
            updateNaturalMovements(t, e) {
                ...
                this.coreModel.addToParamFloat(this.angleXParamIndex, 15 * Math.sin(i / 6.5345) * .5),
                this.coreModel.addToParamFloat(this.angleYParamIndex, 8 * Math.sin(i / 3.5345) * .5),
                this.coreModel.addToParamFloat(this.angleZParamIndex, 10 * Math.sin(i / 5.5345) * .5),
                this.coreModel.addToParamFloat(this.bodyAngleXParamIndex, 4 * Math.sin(i / 15.5345) * .5),
                this.coreModel.setParamFloat(this.breathParamIndex, .5 + .5 * Math.sin(i / 3.2345))
            }
            draw(t) {
        ...
        class at extends x {
            constructor(t) {
                if (super(t), this.motions = {}, !at.isValidJSON(t))
                    throw new TypeError("Invalid JSON.");
                this.moc = t.model,
                c("string", t, this, "textures", "textures"),
                this.copy(t)
            }
            ...
            replaceFiles(t) {
                ...
                for (const [e, i] of Object.entries(this.motions))
                    for (let s = 0; s < i.length; s++)
                        i[s].file = t(i[s].file, `motions.${e}[${s}].file`), void 0 !== i[s].sound && (i[s].sound = t(i[s].sound, `motions.${e}[${s}].sound`));
                if (this.expressions)
        ...
        class lt {
            constructor(t, e) {
                this.coreModel = t,
                this.physicsHairs = [],
                e.physics_hair && (this.physicsHairs = e.physics_hair.map((t => {
                                const e = new PhysicsHair;
                                return e.setup(t.setup.length, t.setup.regist, t.setup.mass),
                                t.src.forEach((({
                                            id: t,
                                            ptype: i,
                                            scale: s,
        ...
        class dt {
            constructor(t, e) {
                ...
                this.partsGroups = [],
                e.parts_visible && (this.partsGroups = e.parts_visible.map((({
                                    group: t
                                }) => t.map((({
                                            id: t,
                                            link: e
                                        ...
                                        const i = new ht(t);
                                        return e && (i.link = e.map((t => new ht(t)))),
                                        i
                                    })))), this.init())
            }
            init() {
            ...
            normalizePartsOpacityGroup(t, e) {
                ...
                t.forEach((({
                        ...
                        if (t >= 0)
                            if (a == e)
                                i.setPartsOpacity(t, r);
                            else {
                                let e,
                                a = i.getPartsOpacity(t);
                                e = r < s ?  - .5 * r / s + 1 : (1 - r) * s / .5,
                                (1 - e) * (1 - r) > .15 && (e = 1 - .15 / (1 - r)),
                                a > e && (a = e),
            ...
            update(t) {
                this.partsGroups.forEach((e => {
                        this.normalizePartsOpacityGroup(e, t),
                        this.copyOpacity(e)
                    }))
            }
        }
        ...
        const ct = class {
            ...
            static cbrt(t) {
                ...
                let s;
                return i && (e = -e),
                e === 1 / 0 ? s = 1 / 0 : (s = Math.exp(Math.log(e) / 3), s = (e / (s * s) + 2 * s) / 3),
                i ? -s : s
            }
            ...
            static directionToDegrees(t, e) {
                ...
                return e.x - t.x > 0 && (s = -s),
                s
            }
            static radianToDirection(t) {
                const e = new ut;
                return e.x = this.sin(t),
                e.y = this.cos(t),
                e
            }
        ...
        class Ct {
            static startUp(t) {
                if (yt)
                    return It("CubismFramework.startUp() is already done."), yt;
                ...
                return It("CubismFramework.startUp() is complete."),
                yt
            }
            static cleanUp() {
                yt = !1,
        ...
        class Et {
            ...
            updateParameters(t, e, i) {
                ...
                let s = this._weight;
                s = s * (0 == this._fadeInSeconds ? 1 : gt.getEasingSine((i - e.getFadeInStartTime()) / this._fadeInSeconds)) * (0 == this._fadeOutSeconds || e.getEndTime() < 0 ? 1 : gt.getEasingSine((e.getEndTime() - i) / this._fadeOutSeconds)),
                e.setState(i, s),
        ...
        class Ft extends Et {
            ...
            static create(t) {
                ...
                i = t.FadeInTime,
                s = t.FadeOutTime;
                e.setFadeInTime(void 0 !== i ? i : 1),
                e.setFadeOutTime(void 0 !== s ? s : 1);
        ...
        class Bt {
            ...
            isFinishedByHandle(t) {
                for (let e = 0; e < this._motions.length; e++) {
                    ...
                    if (null != i && (i._motionQueueEntryHandle == t && !i.isFinished()))
                        return !1
                }
                return !0
            }
            ...
            doUpdateMotion(t, e) {
                ...
                for (; s < this._motions.length; ) {
                    ...
                    a.updateParameters(t, r, e),
                    i = !0;
                    const o = a.getFiredEvent(r.getLastCheckEventSeconds() - r.getStartTime(), e - r.getStartTime());
                    for (let t = 0; t < o.length; ++t)
                        this._eventCallBack(this, o[t], this._eventCustomData);
                    r.setLastCheckEventSeconds(e),
                    r.isFinished() ? (r.release(), this._motions.splice(s, 1)) : (r.isTriggeredFadeOut() && r.startFadeOut(r.getFadeOutSeconds(), e), s++)
                }
                return i
            }
        }
        ...
        function qt(t, e, i) {
            const s = new Gt;
            return s.time = t.time + (e.time - t.time) * i,
        ...
        function $t(t, e) {
            ...
            return i < 0 && (i = 0),
            t[0].value + (t[1].value - t[0].value) * i
        }
        function Zt(t, e) {
        ...
        class ee extends Et {
            ...
            doUpdateParameters(t, e, i, s) {
                ...
                for (; m < this._motionData.curveCount && f[m].type == Nt.CubismMotionCurveTarget_Parameter; ++m) {
                    ...
                    let a;
                    if (f[m].fadeInTime < 0 && f[m].fadeOutTime < 0)
                        a = r + (g - r) * i;
                    else {
                        let t,
                        i;
                        t = f[m].fadeInTime < 0 ? u : 0 == f[m].fadeInTime ? 1 : gt.getEasingSine((e - s.getFadeInStartTime()) / f[m].fadeInTime),
                        i = f[m].fadeOutTime < 0 ? c : 0 == f[m].fadeOutTime || s.getEndTime() < 0 ? 1 : gt.getEasingSine((s.getEndTime() - e) / f[m].fadeOutTime);
                ...
                for (; m < this._motionData.curveCount && f[m].type == Nt.CubismMotionCurveTarget_PartOpacity; ++m)
                    if (g = te(this._motionData, m, _), a.setOpacityFromMotion)
                        t.setPartOpacityById(f[m].id, g);
                    else {
                        if (p = t.getParameterIndex(f[m].id), -1 == p)
                            continue;
                        t.setParameterValueByIndex(p, g)
                    }
                r >= this._motionData.duration && (this._isLoop ? (s.setStartTime(e), this._isLoopFadeIn && s.setFadeInStartTime(e)) : (this._onFinishedMotion && this._onFinishedMotion(this), s.setIsFinished(!0))),
                this._lastWeight = i
            }
            setIsLoop(t) {
                this._isLoop = t
            ...
            setParameterFadeInTime(t, e) {
                ...
                for (let s = 0; s < this._motionData.curveCount; ++s)
                    if (t == i[s].id)
                        return void(i[s].fadeInTime = e)
            }
            setParameterFadeOutTime(t, e) {
                const i = this._motionData.curves;
                for (let s = 0; s < this._motionData.curveCount; ++s)
                    if (t == i[s].id)
                        return void(i[s].fadeOutTime = e)
            }
            ...
            setEffectIds(t, e) {
                this._eyeBlinkParameterIds = t,
                this._lipSyncParameterIds = e
            }
            release() {
            ...
            parse(t) {
                ...
                for (let n = 0; n < this._motionData.curveCount; ++n) {
                    ...
                    t.id = e.getMotionCurveId(n),
                    t.baseSegmentIndex = o;
                    const s = e.getMotionCurveFadeInTime(n),
                    r = e.getMotionCurveFadeOutTime(n);
                    t.fadeInTime = void 0 !== s ? s : -1,
                    t.fadeOutTime = void 0 !== r ? r : -1;
        ...
        class ie extends C {
            ...
            _startMotion(t, e) {
                return t.setFinishedMotionHandler(e),
                this.queueManager.stopAllMotions(),
            ...
            createMotion(e, i, s) {
                ...
                return void 0 === a.getMotionFadeInTime() && r.setFadeInTime(s.FadeInTime > 0 ? s.FadeInTime : o),
        ...
        const ae = class {
            ...
            updateParameters(t, e) {
                ...
                case ne.EyeState_Interval:
                    this._nextBlinkingTime < this._userTimeSeconds && (this._blinkingState = ne.EyeState_Closing, this._stateStartTimeSeconds = this._userTimeSeconds),
                    i = 1;
                    break;
                case ne.EyeState_First:
                default:
                    this._blinkingState = ne.EyeState_Interval,
                    this._nextBlinkingTime = this.determinNextBlinkingTiming(),
                    i = 1
                }
                ae.CloseIfZero || (i = -i);
                for (let r = 0; r < this._parameterIds.length; ++r)
                    t.setParameterValueById(this._parameterIds[r], i)
            }
            constructor(t) {
                var e,
                i;
                ...
                this._userTimeSeconds = 0,
                this._parameterIds = [],
                null != t && (this._parameterIds = null != (i = null == (e = t.getEyeBlinkParameters()) ? void 0 : e.slice()) ? i : this._parameterIds)
            }
        ...
        class ce {
            ...
            setupClippingContext(t, e) {
                ...
                for (let s = 0; s < this._clippingContextListForMask.length; s++) {
                    ...
                    this.calcClippedDrawTotalBounds(t, e),
                    e._isUsing && i++
                }
                if (i > 0) {
                ...
                for (let r = 0; r < 4; r++) {
                    ...
                    if (0 == t);
                        ...
                        for (let e = 0; e < t; e++) {
                            ...
                            i._layoutBounds.x = .5 * t,
                            i._layoutBounds.y = 0,
                            i._layoutBounds.width = .5,
                        ...
                        for (let e = 0; e < t; e++) {
                            ...
                            a._layoutBounds.x = .5 * t,
                            a._layoutBounds.y = .5 * i,
                            a._layoutBounds.width = .5,
                            a._layoutBounds.height = .5
                        }
                    else if (t <= 9)
                        for (let e = 0; e < t; e++) {
                            let t = e % 3,
                        ...
                        Tt("not supported mask count : {0}", t)
                }
            }
            getColorBuffer() {
        ...
        class pe {
            ...
            setupShaderProgram(t, e, i, s, r, a, o, n, l, h, d, u, c) {
                ...
                p,
                _;
                d || Tt("NoPremultipliedAlpha is not allowed"),
        ...
        class Se extends pt {
            ...
            doDrawModel() {
                this.preDraw(),
                null != this._clippingManager && this._clippingManager.setupClippingContext(this.getModel(), this);
            ...
            drawMesh(t, e, i, s, r, a, o, n, l) {
                ...
                pe.getInstance().setupShaderProgram(this, d, i, r, s, a, this._bufferData, o, n, h, this.isPremultipliedAlpha(), this.getMvpMatrix(), l),
            ...
            preDraw() {
                this.firstDraw && (this.firstDraw = !1, this._anisortopy = this.gl.getExtension("EXT_texture_filter_anisotropic") || this.gl.getExtension("WEBKIT_EXT_texture_filter_anisotropic") || this.gl.getExtension("MOZ_EXT_texture_filter_anisotropic")),
        ...
        class Ie extends b {
            ...
            init() {
                ...
                this.breath.setParameters([new re(this.idParamAngleX, 0, 15, 6.5345, .5), new re(this.idParamAngleY, 0, 8, 3.5345, .5), new re(this.idParamAngleZ, 0, 10, 5.5345, .5), new re(this.idParamBodyAngleX, 0, 4, 15.5345, .5), new re(this.idParamBreath, 0, .5, 3.2345, .5)]),
            ...
            return Ct.isStarted() ? Promise.resolve() : (null != we || (we = new Promise(((t, e) => {
                                !function i() {
                                    try {
                                        ...
                                        l.log("Cubism4", "Startup failed, retrying 10ms later..."),
                                        setTimeout(i, 10)
                                    }
                                }
                                ()
        ...
        class Fe {
            ...
            doFade(t, e, i, s) {
                ...
                for (let n = i; n < i + s; ++n) {
                    ...
                    if (r == n)
                        t.setPartOpacityByIndex(e, a);
                    else {
                        let i,
                        s = t.getPartOpacityByIndex(e);
                        i = a < o ?  - .5 * a / o + 1 : (1 - a) * o / .5;
                        (1 - i) * (1 - a) > .15 && (i = 1 - .15 / (1 - a)),
                        s > i && (s = i),
        ...
        class De {
            ...
            assignment(t) {
                return this.partId = t.partId,
                this.link = t.link.map((t => t.clone())),
                this
            }
            initialize(t) {
        ...
        class Be {
            ...
            createModel() {
                ...
                if (e)
                    return t = new Ae(e), ++this._modelCount, t;
                throw new Error("Unknown error")
            }
            deleteModel(t) {
        ...
        class Ve {
            constructor() {
                this.destination = {},
                this.translationScale = new ut(0, 0)
            }
        }
        class Ge {
            constructor() {
        ...
        class je {
            ...
            getGravity() {
                const t = new ut(0, 0);
                return t.x = this._json.Meta.EffectiveForces.Gravity.X,
                t.y = this._json.Meta.EffectiveForces.Gravity.Y,
                t
            }
            getWind() {
                const t = new ut(0, 0);
                return t.x = this._json.Meta.EffectiveForces.Wind.X,
            ...
            getParticlePosition(t, e) {
                const i = new ut(0, 0);
                return i.x = this._json.PhysicsSettings[t].Vertices[e].Position.X,
            ...
            evaluate(t, e) {
                ...
                for (let p = 0; p < this._physicsRig.subRigCount; ++p) {
                    ...
                    for (let e = 0; e < n.outputCount; ++e) {
                        ...
                        si(o, g[r], c[r], a, h[e]);
                        for (let t = r, e = 0; t < u.length; t++, e++)
                            u[t] = o[e]
                    }
                }
            }
            ...
            parse(t) {
                ...
                for (let a = 0; a < this._physicsRig.subRigCount; ++a) {
                    ...
                    for (let i = 0; i < t.inputCount; ++i) {
                        ...
                        case "X":
                            t.type = Oe.CubismPhysicsSource_X,
                            t.getNormalizedParameterValue = Ye;
                            break;
                        case "Y":
                            t.type = Oe.CubismPhysicsSource_Y,
                            t.getNormalizedParameterValue = He;
                            break;
                        case Xe:
                            t.type = Oe.CubismPhysicsSource_Angle,
                            t.getNormalizedParameterValue = qe
                        }
                        t.source.targetType = Re.CubismPhysicsTargetType_Parameter,
                        t.source.id = e.getInputSourceId(a, i),
                        this._physicsRig.inputs.push(t)
                    }
                    t.outputCount = e.getOutputCount(a),
                    t.baseOutputIndex = s,
                    s += t.outputCount;
                    for (let i = 0; i < t.outputCount; ++i) {
                        ...
                        t.reflect = e.getOutputReflect(a, i),
                        this._physicsRig.outputs.push(t)
                    }
                    t.particleCount = e.getParticleCount(a),
            ...
            initialize() {
                ...
                for (let s = 0; s < this._physicsRig.subRigCount; ++s) {
                    ...
                    for (let s = 1; s < e.particleCount; ++s)
                        i = new ut(0, 0), i.y = t[s].radius, t[s].initialPosition = new ut(t[s - 1].initialPosition.x + i.x, t[s - 1].initialPosition.y + i.y), t[s].position = new ut(t[s].initialPosition.x, t[s].initialPosition.y), t[s].lastPosition = new ut(t[s].initialPosition.x, t[s].initialPosition.y), t[s].lastGravity = new ut(0, -1), t[s].lastGravity.y *= -1, t[s].velocity = new ut(0, 0), t[s].force = new ut(0, 0)
                }
            }
        }
        class We {
        ...
        function Je(t, e, i, s, r) {
            let a;
            return r = i >= 2 ? e[i - 1].position.substract(e[i - 2].position) : r.multiplyByScaler(-1),
        ...
        function si(t, e, i, s, r) {
            ...
            o = s * a,
            o < e ? (o < r.valueBelowMinimum && (r.valueBelowMinimum = o), o = e) : o > i && (o > r.valueExceededMaximum && (r.valueExceededMaximum = o), o = i),
            n = r.weight / 100,
            n >= 1 || (o = t[0] * (1 - n) + o * n),
            t[0] = o
        }
        ...
        N.registerRuntime({
            ...
            createInternalModel(t, e, i) {
                ...
                r = t;
                return r.__moc && (s.__moc = r.__moc, delete r.__moc, s.once("destroy", ai)),
                s
            },
